...
def predict():
    ...
    res = {x_cols[i]: inp_features[i] for i in range(len(test_keys))}
    ...
    return render_template('index.html', Text = "For The Given Properties: {}".format(res),Estimation = "Estimated Price: {} Rupees".format(output))
